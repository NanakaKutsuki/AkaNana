...
public class ActionSearchTest {
    ...
    // testGameplay(playerHands.get(0), 2, false, false, false, false, false,
    // false);
    ...
    // as.dealerAction(playerHands, otherPlayers, dealerHand, shoe);
    // as.payout(playerHands, dealerHand);
    // testGameplay(playerHands.get(0), 3, false, false, false, false, false,
    // false);
    // testGameplay(dealerHand, 2, false, false, false, false, false, false);
    // assertEquals("Wrong Payout", BigDecimal.TEN, as.getBankroll());
    //
    ...
    // as.dealerAction(playerHands, otherPlayers, dealerHand, shoe);
    // as.payout(playerHands, dealerHand);
    // testGameplay(playerHands.get(0), 3, false, true, false, false, false,
    // false);
    // testGameplay(dealerHand, 2, false, false, false, false, false, false);
    // assertEquals("Wrong Payout", BigDecimal.TEN.negate(), as.getBankroll());
    //
    ...
    // true);
    // testGameplay(dealerHand, 2, false, false, false, false, false, false);
    // assertEquals("Wrong Payout", BigDecimal.valueOf(5).negate(),
    // s.getBankroll());
    //
    ...
    // as.dealerAction(playerHands, otherPlayers, dealerHand, shoe);
    // as.payout(playerHands, dealerHand);
    // testGameplay(playerHands.get(0), 3, false, false, true, false, false,
    // false);
    // testGameplay(dealerHand, 2, false, false, false, false, false, false);
    ...
    // as.dealerAction(playerHands, otherPlayers, dealerHand, shoe);
    // as.payout(playerHands, dealerHand);
    // testGameplay(playerHands.get(0), 3, false, true, true, false, false,
    // false);
    // testGameplay(dealerHand, 2, false, false, false, false, false, false);
    // assertEquals("Wrong Payout", BigDecimal.valueOf(-20), as.getBankroll());
    //
    ...
    // as.dealerAction(playerHands, otherPlayers, dealerHand, shoe);
    // as.payout(playerHands, dealerHand);
    // testGameplay(playerHands.get(0), 3, false, false, true, false, true,
    // false);
    // testGameplay(playerHands.get(1), 4, false, false, false, false, true,
    // false);
    // testGameplay(dealerHand, 2, false, false, false, false, false, false);
    ...
    // as.dealerAction(playerHands, otherPlayers, dealerHand, shoe);
    // as.payout(playerHands, dealerHand);
    // testGameplay(playerHands.get(0), 3, false, false, false, false, true,
    // false);
    // testGameplay(playerHands.get(1), 3, false, true, false, false, true,
    // false);
    // testGameplay(dealerHand, 2, false, false, false, false, false, false);
    // assertEquals("Wrong Payout", BigDecimal.valueOf(-20), as.getBankroll());
    //
    ...
    // as.dealerAction(playerHands, otherPlayers, dealerHand, shoe);
    // as.payout(playerHands, dealerHand);
    // testGameplay(playerHands.get(0), 2, false, false, false, false, true,
    // false);
    // testGameplay(playerHands.get(1), 2, false, false, false, false, true,
    // false);
    // testGameplay(playerHands.get(2), 2, false, false, false, false, true,
    // false);
    // testGameplay(dealerHand, 2, false, false, false, false, false, false);
    // assertEquals("Wrong Payout", BigDecimal.valueOf(30), as.getBankroll());
    //
    ...
    // s.payout(playerHands, dealerHand);
    //
    // assertEquals("Wrong Card", expectedCard1,
    // playerHands.get(0).getHand().get(0));
    // assertEquals("Wrong Card", expectedCard2, dealerHand.getHand().get(0));
    // assertEquals("Wrong Card", expectedCard3,
    // playerHands.get(0).getHand().get(1));
    ...
    //
    // // testFindShoeByValue
    // private void testFindShoeByValue(AbstractShoe shoe, int card1, int card2,
    // int showing, Integer count) {
    // Hand hand = new Hand();
    // if (card1 == 11) {
    ...
    // as.call();
    //
    // assertEquals("Wrong player value", hand.getValue(),
    // as.getPlayerHands().get(0).getValue());
    // assertEquals("Wrong dealer showing", showing,
    // as.getDealerHand().showingRank());
    //
    // if (count != null) {
    ...
    //
    // // testFindShoeByCards
    // private void testFindShoeByCards(AbstractShoe shoe, int card1, int card2,
    // int showing, Integer count) {
    // as.setSettings(card1, card2, showing, count, shoe, basic);
    // as.call();
    //
    ...
    // fail("Wrong Cards " + as.getPlayerHands().get(0) + " suppose to be " +
    // card1 + " " + card2);
    // }
    //
    // assertEquals("Wrong dealer showing", showing,
    ...
    // private void testGameplay(Hand hand, int expectedSize, boolean
    // expectedBlackjack, boolean expectedBust,
    // boolean expectedDoubleDown, boolean expectedInsurance, boolean
    // expectedSplit, boolean expectedSurrender) {
    // assertEquals("Wrong number of Cards " + hand, expectedSize, hand.size());
    // assertEquals("Wrong Blackjack " + hand, expectedBlackjack,
    // hand.isBlackjack());
    // assertEquals("Wrong Bust " + hand, expectedBust, hand.isBust());
    // assertEquals("Wrong Double Down " + hand, expectedDoubleDown,
    // hand.isDoubleDown());
    // assertEquals("Wrong Insurance " + hand, expectedInsurance,
    // hand.isInsurance());
    // assertEquals("Wrong Split " + hand, expectedSplit, hand.isSplit());
    // assertEquals("Wrong Surrender " + hand, expectedSurrender,
    // hand.isSurrender());
    // }
}
